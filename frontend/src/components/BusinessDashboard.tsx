    ...
    <div className="p-8 space-y-8 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-4">
          <button className="flex gap-2 items-center px-4 py-2 bg-[#7F30FA] hover:bg-[#6c28d9] text-white text-sm font-medium rounded-md transition-colors">
            <IconShoppingCart />
            Registrar Venta
          </button>
          <button className="flex items-center px-4 py-2 border border-[#922340] text-[#922340] hover:bg-[#922340]/10 text-sm font-medium rounded-md transition-colors">
            <IconReceipt />
            Registrar Gasto
          </button>
        </div>
