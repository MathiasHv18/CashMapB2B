// Todos los íconos SVG de la app en un solo lugar.
// Uso: import { IconMail, IconLock } from "./icons"
...
// open=true → ojo abierto | open=false → ojo tachado
...
export function IconReceipt() {
  return (
    ...
    >
      ...
      <path d="M16 14h-6.5a2.5 2.5 0 0 1 0-5H11" />
      <path d="M8 9h.01" />
      <path d="M12 18v-9" />
    </svg>
  );
