// Left-side marketing panel shown on desktop auth screens.

import Feature from "./Feature";
import { IconBolt, IconChart, IconMoney } from "../ui/icons";
    ...
    <div className="hidden lg:flex flex-col justify-center px-16 xl:px-24 w-1/2 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md">
        <h1 className="text-white font-extrabold text-4xl xl:text-5xl leading-tight tracking-tight">
          ...
          <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 to-purple-300">
            dinero real
          </span>
        </h1>
